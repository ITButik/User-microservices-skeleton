...
public class ErrorHandlerMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        catch (ExternalServiceException ex)
        {
            ...
            await context.Response.WriteAsync(JsonSerializer.Serialize(getErrorObject("External Service error", ex)));
        }
        catch (Exception ex)
        {
            ...
            context.Response.StatusCode = 500;
            context.Response.ContentType = "application/json";
            await context.Response.WriteAsync(JsonSerializer.Serialize(getErrorObject("Exception", ex)));
        }
    }
